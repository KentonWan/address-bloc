...
describe("ContactController", () => {
  ...
  describe("#getContacts()",() => {
    ...
    it("should return an array of contacts when contact are available",(done)=>{
  ...
  describe("search methods", ()=> {
    ...
    const alloy = ["Alloy Rodriguez", "000-100-1111", "allow@guerrila-games.com"];
    ...
    describe("#iterativeSearch()",() => {
      ...
      it("it should return the contact if found", (done)=> {
    ...
    describe("#binarySearch()",()=> {
      ...
      it("should return null when called by an empty array",()=> {
